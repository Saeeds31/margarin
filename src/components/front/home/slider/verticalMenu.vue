<template>
  <div id="verticalMenu" class="width5 height60 hiddenInMobile">
    <ul class="d-flex justify-content-between align-items-center flex-direction-column height100">
      <li>
        <router-link to="/">
     <svg id="Layer_1" enable-background="new 0 0 511.995 511.995" height="37" viewBox="0 0 511.995 511.995" width="32" xmlns="http://www.w3.org/2000/svg"><g><path d="m507.308 236.641-198.98-198.99c-28.86-28.85-75.8-28.85-104.66 0l-198.98 198.99c-6.25 6.25-6.25 16.38 0 22.63 6.24 6.25 16.38 6.25 22.62 0l12.69-12.69v203.4c0 25.405 20.595 46 46 46h80c5.523 0 10-4.477 10-10v-148c0-27.614 22.386-50 50-50h60c27.614 0 50 22.386 50 50v148c0 5.523 4.477 10 10 10h80c25.405 0 46-20.595 46-46v-203.4l12.69 12.69c3.12 3.12 7.22 4.69 11.31 4.69s8.19-1.57 11.31-4.69c6.25-6.25 6.25-16.38 0-22.63z"/></g></svg>
        </router-link>
        <p>صفحه اصلی</p>
      </li>
      <li>
      ...
      <li>
        <router-link to="/">
         <svg id="Capa_1" enable-background="new 0 0 512 512" height="37" viewBox="0 0 512 512" width="32" xmlns="http://www.w3.org/2000/svg"><g><path d="m132.725 232.427 21.439 32.158-21.439 32.158v215.257h246.55v-215.257l-21.439-32.158 21.439-32.158v-82.331h-246.55z"/><path d="m379.275 103.747c0-24.134-19.565-43.699-43.699-43.699h-34.552v-60.048h-90.049v60.048h-34.552c-24.134 0-43.699 19.565-43.699 43.699v16.349h246.55v-16.349z"/></g></svg>
         </router-link>
        <p>محصولات</p>
      </li>
      ...
      <li>
        <router-link to="/">
<svg version="1.1" width="32" height="37" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<g>
      ...
      <li>
        <router-link to="/">
       <svg height="37" viewBox="0 0 511 511.99897" width="32" xmlns="http://www.w3.org/2000/svg"><path d="m298.484375 24.015625c4.980469-6.621094 3.648437-16.023437-2.972656-21.003906-6.617188-4.976563-16.023438-3.648438-21.003907 2.972656l-63.933593 85.015625h37.535156zm0 0"/><path d="m143.777344 91h37.242187l-62.4375-84.886719c-4.910156-6.675781-14.296875-8.105469-20.96875-3.195312-6.675781 4.910156-8.105469 14.296875-3.199219 20.96875zm0 0"/><path d="m276.496094 211h-159.996094c-13.785156 0-25 11.214844-25 25v129.996094c0 13.785156 11.214844 25 25 25h159.996094c13.785156 0 25-11.214844 25-25v-129.996094c0-13.785156-11.214844-25-25-25zm0 0"/><path d="m406.496094 358.996094c-8.273438 0-15 6.730468-15 15 0 8.273437 6.726562 15 15 15 8.269531 0 15-6.726563 15-15 0-8.269532-6.730469-15-15-15zm0 0"/><path d="m467.496094 121h-421.996094c-24.8125 0-45 20.1875-45 45v268.996094c0 24.8125 20.1875 45 45 45h22.402344l-4.984375 10.632812c-3.515625 7.5-.285157 16.433594 7.214843 19.949219 7.496094 3.511719 16.429688.289063 19.949219-7.214844l10.953125-23.367187h310.925782l10.953124 23.367187c3.515626 7.503907 12.445313 10.730469 19.945313 7.214844 7.503906-3.519531 10.734375-12.449219 7.214844-19.949219l-4.980469-10.632812h22.398438c24.816406 0 45-20.1875 45-45v-268.996094c.003906-24.8125-20.183594-45-44.996094-45zm-136 244.996094c0 30.328125-24.671875 55-55 55h-159.996094c-30.328125 0-55-24.671875-55-55v-129.996094c0-30.328125 24.671875-55 55-55h159.996094c30.328125 0 55 24.671875 55 55zm75 53c-24.8125 0-45-20.1875-45-45s20.1875-45 45-45 45 20.1875 45 45-20.1875 45-45 45zm30-148h-60c-8.285156 0-15-6.714844-15-15 0-8.28125 6.714844-15 15-15h60c8.28125 0 15 6.71875 15 15 0 8.285156-6.71875 15-15 15zm0-59.996094h-60c-8.285156 0-15-6.71875-15-15 0-8.285156 6.714844-15 15-15h60c8.28125 0 15 6.714844 15 15 0 8.28125-6.71875 15-15 15zm0 0"/></svg>
        </router-link>
        <p>آموزش</p>
      </li>
      <li>
        <router-link to="/">
    <svg id="Layer_1" enable-background="new 0 0 510 510" height="37" viewBox="0 0 510 510" width="32" xmlns="http://www.w3.org/2000/svg"><g id="XMLID_3990_"><path id="XMLID_3994_" d="m90 90h390v60h-390z"/><path id="XMLID_4088_" d="m90 180v255 15c0 10.876-2.871 21.135-7.965 30h338.965c49.075 0 89-39.925 89-89v-211c-37.127 0-324.82 0-420 0zm225 195h-165v-150h165zm135 0h-105v-30h105zm0-60h-105v-30h105zm0-60h-105v-30h105z"/><path id="XMLID_4092_" d="m180 255h105v90h-105z"/><path id="XMLID_4093_" d="m157.5 30c-19.246 0-60.584 0-97.5 0-24.563 0-47.168 0-60 0v405 15c0 16.568 13.432 30 30 30 2.318 0 4.572-.272 6.74-.77 13.322-3.06 23.26-14.98 23.26-29.23v-390h120z"/></g></svg>
      ...
      <li>
        <router-link to="/">
        <svg id="Capa_1" enable-background="new 0 0 512.001 512.001" height="37" viewBox="0 0 512.001 512.001" width="32" xmlns="http://www.w3.org/2000/svg"><g><path d="m507.609 391.94-53.302-53.319c-10.047 12.807-23.141 23.065-37.984 29.742-8.583 19.08-23.066 35.296-41.304 45.826-15.189 8.77-32.499 13.406-50.056 13.406-.001 0-.002 0-.003 0-3.445 0-6.885-.178-10.304-.531-.635.457-1.284.891-1.929 1.333l79.21 79.21c2.86 2.86 6.694 4.394 10.608 4.394 1.632 0 3.277-.267 4.872-.814 5.42-1.862 9.306-6.65 10.012-12.337l8.993-72.425 72.425-8.993c5.687-.706 10.475-4.591 12.337-10.011 1.865-5.421.476-11.428-3.575-15.481z"/><path d="m187.038 427.594c-17.559 0-34.869-4.636-50.059-13.406-18.236-10.529-32.719-26.745-41.302-45.825-14.842-6.677-27.936-16.936-37.984-29.742l-53.301 53.319c-4.051 4.053-5.44 10.06-3.577 15.48 1.862 5.419 6.65 9.305 12.337 10.011l72.425 8.993 8.993 72.425c.706 5.688 4.592 10.475 10.012 12.337 5.421 1.861 11.429.473 15.48-3.58l79.21-79.21c-.645-.442-1.295-.876-1.93-1.333-3.418.354-6.858.531-10.304.531z"/><path d="m306.1 395.016c18.013 5.02 37.47 2.689 53.92-6.809 16.45-9.497 28.197-25.183 32.856-43.292 18.109-4.66 33.794-16.407 43.291-32.856 9.498-16.45 11.828-35.907 6.809-53.919 13.353-13.09 21.063-31.105 21.063-50.1s-7.71-37.011-21.063-50.101c5.019-18.012 2.688-37.47-6.809-53.919-9.497-16.45-25.182-28.197-43.291-32.856-4.66-18.109-16.407-33.794-32.856-43.292-16.45-9.498-35.907-11.827-53.92-6.809-13.089-13.352-31.105-21.063-50.1-21.063s-37.01 7.71-50.1 21.063c-18.011-5.019-37.469-2.688-53.92 6.809-16.45 9.497-28.197 25.183-32.856 43.292-18.109 4.66-33.794 16.407-43.291 32.856-9.498 16.45-11.828 35.907-6.809 53.919-13.353 13.09-21.063 31.105-21.063 50.101 0 18.995 7.71 37.01 21.063 50.1-5.019 18.012-2.688 37.47 6.809 53.919 9.497 16.45 25.182 28.197 43.291 32.856 4.66 18.109 16.407 33.794 32.856 43.292 16.45 9.498 35.907 11.828 53.92 6.809 13.09 13.353 31.105 21.063 50.1 21.063s37.011-7.71 50.1-21.063zm-173.459-186.976c0-68.021 55.339-123.36 123.36-123.36s123.36 55.339 123.36 123.36-55.34 123.36-123.361 123.36-123.359-55.339-123.359-123.36z"/><path d="m256 301.4c51.479 0 93.36-41.881 93.36-93.36s-41.881-93.36-93.36-93.36-93.36 41.881-93.36 93.36 41.881 93.36 93.36 93.36zm36.147-57.213c-9.655 9.655-22.492 14.973-36.147 14.973s-26.492-5.317-36.147-14.973c-5.858-5.858-5.858-15.355 0-21.213 5.857-5.858 15.355-5.858 21.213 0 8.235 8.234 21.633 8.234 29.868 0 5.857-5.858 15.355-5.858 21.213 0s5.858 15.355 0 21.213z"/></g></svg>
        </router-link>
        <p>افتخارات</p>
      </li>
      <li>
...
<svg version="1.1" width="32" height="37" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
