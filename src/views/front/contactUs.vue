  ...
  watch: {
    contactUsData(newVal) {
      this.$store.commit("setContactUsCartsData",{
        ...
        info: {
          title1_fa: "همواره پشتیبان شما هستیم",
          title1_en: "We are always your support",
