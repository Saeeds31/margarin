            ...
            >
              ...
              <button class="comment d-flex justify-content-around">
                ...
                >
                  <image
                    id="Layer_2502"
                    data-name="Layer 2502"
                    width="24"
                    height="20"
                    opacity="0.6"
                    xlink:href="data:image/png;base64,"
                  />
                </svg>
              </button>
            </div>
